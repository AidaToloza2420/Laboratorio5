...
CONFIG_TMR0:
 ...
 CONFIG_IO:
    ...
    BANKSEL TRISA
    BSF TRISB, UP ; ((PORTB) and 07Fh), 0 como entrada / Botón modo
    BSF TRISB, DOWN ; ((PORTB) and 07Fh), 1 como entrada / Botón acción
    ...
    CLRF CENTENA ; Limpiamos GPR
    CLRF DECENA ; Limpiamos GPR
    CLRF UNIDADES ; Limpiamos GPR
...
CONFIG_INT:
    ...
    BSF ((INTCON) and 07Fh), 3 ; Habilitamos interrupción puerto B
